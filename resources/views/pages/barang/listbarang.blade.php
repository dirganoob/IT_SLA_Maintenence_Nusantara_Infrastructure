                                                        ...
                                                        <form action="{!! url('/listbarang/tambahstock/' . $b->id) !!}" method="POST">
                                                            ...
                                                            <div class="card">
                                                                <label class="form-label">Jumlah Barang
                                                                    Masuk</label>
                                                                <input min='0' type="number" name="stock" id="stock"
                                                                    class="form-control">
                                                            </div>
                    ...
                    <form action="{!! url('/listbarang') !!}" method="POST">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col mb-0">
                                ...
                                <input min='0' type="number" id="unit" name="unit" class="form-control"
                        ...
                        <div class="row g-2 ">
                            ...
                            <div class="col mb-0 mt-3">
                                ...
                                <input min='0' type="number" id="stock" name="stock" class="form-control"
                                    placeholder="Stock" />
                            </div>
                        </div>
                        <div class="mt-3">

                ...
                <form action="/toll" method="get">
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <label for="form-select" class="form-label">Pilih Lokasi</label>
                        </div>
                        <div class="col mb-0">
                            <select id="cari" name="search2" class="form-select">
                                <option value="" selected>Semua Kategori</option>
                                @foreach ($kategori as $l)
                                    <option>{{ $l->nama }}</option>
                                @endforeach
                            </select>
                            <label for="form-select" class="form-label">Pilih Kategori</label>
                        </div>
                        <div class="col mb-0">
